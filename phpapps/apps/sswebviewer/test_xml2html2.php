...
class Test_xml2html_extra extends PHPUnit_Framework_TestCase
{
	...
	public function test_addlinks()
	{
		...
		$this->expected_result = '<table id=table ><tr><td class="cell" bgcolor=#ffffff fgcolor=#000000><a href="getlink.php?source_type=dow&source_value="></a></td><td class="cell" bgcolor=#ffffff fgcolor=#000000><a href="getlink.php?source_type=dow&source_value=MO">MO</a></td></tr><tr><td class="cell" bgcolor=#ffffff fgcolor=#000000><a href="getlink.php?source_type=period&source_value=830-910">830-910</a></td><td><table id=table><tr><td class="cell sub left" bgcolor=#ffcc99 fgcolor=#ffffff><a href="getlink.php?source_type=subject&source_value=ELA">ELA</a></td></tr></table></td></tr></table> ';
...
class Test_xml2html_drawform extends PHPUnit_Framework_TestCase
{
	public function test_()
	{
		ob_start(); // buffer echos; so can use buffer in string compare of output
		
		$this->expected_result = '<html><body><form action="update.php" method="post" accept-charset="UTF-8"><fieldset><div class="container"><label for="period" >period</label><input type="text" name="period" id="period" list="suggestions0" value="830-910"><datalist id="suggestions0"><option>830-910</option><option>910-950</option><option>950-1030</option><option>1030-1110</option><option>1110-1210</option><option>1210-100</option><option>100-140</option><option>140-220</option><option>220-300</option><option>300-330</option></datalist></div><div class="container"><label for="dow" >dow</label><input type="text" name="dow" id="dow" list="suggestions1" value="MO"><datalist id="suggestions1"><option>MO</option><option>TU</option><option>WE</option><option>TH</option><option>FR</option></datalist></div></fieldset></form></body></html>';
										
		$this->xmlstr = '<root>
								 <parser>
								 	<value>drawform</value>
								 </parser>
		                   <item>
		                     <valuetype>period</valuetype>
		                     <value>830-910</value>
	...
	{
	 	$this->xmlstr = '<root><parser><value>drawform</value></parser><item id="1"><value>master</value><valuetype>status</valuetype></item><item id="2"><value>wp</value><valuetype>recordtype</valuetype></item><item id="3"><value>1030-1110</value><valuetype>period</valuetype></item><item id="4"><value>complete</value><valuetype>substatus</valuetype></item><item id="5"><value>dbinsert</value><valuetype>source</valuetype></item><item id="6"><value>Stan.Math.Tuesday.1030-1110</value><valuetype>session</valuetype></item><item id="7"><value>Stan</value><valuetype>adult</valuetype></item><item id="8"><value>Nathaniel</value><valuetype>student</valuetype></item><item id="9"><value>03FC4108</value><valuetype>id</valuetype></item><item id="10"><value>lesson</value><valuetype>objtype</valuetype></item><item id="11"><value>TU</value><valuetype>dow</valuetype></item><item id="12"><value>4.2.1.2.4</value><valuetype>userobjid</valuetype></item><item id="13"><value>Math</value><valuetype>subject</valuetype></item></root>';
...
$std = new Test_xml2html_drawform();

$std->test_full_record();
