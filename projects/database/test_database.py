...
import unittest
import sys
from database import get_db_tables, create_db_from_schema, sqlite3, NAME_ATTRIB, get_db_table_columns, insert_rows_from_file, \
     get_db_table_rows, db_add_table_complex
...
class TestTablePrimaryKey(unittest.TestCase):
