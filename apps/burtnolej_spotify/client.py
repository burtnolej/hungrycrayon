...
class Spotify(object):
    ...
    def artist_related_artists(self, artist_id,limit=20, offset=0):
    ...
    def user_playlist_unfollow(self, owner,playlist_id):
        ''' Unfollows a playlist (which is how spotify API implements delete)

            Parameters:
                - owner_id - the user id of the owner of the playlist
                - playlist_id - the id of the playlist
        ...
        return self._delete("users/%s/playlists/%s/followers" % (owner, plid))
